      ...
      <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-[#03045e] leading-tight">
            Commonly Asked <span className="text-[#00b4d8]">Questions</span>
          </h2>

          {/* Short Description */}
          <p className="text-gray-500 text-lg md:text-xl max-w-xl leading-relaxed">
            Everything you need to know about our courses, mentorship, and
            learning paths. Can't find what you're looking for? Our team is
            ready to help.
          </p>
